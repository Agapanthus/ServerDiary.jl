...
const SAR_DB = Dict(
"B" => ("-B", "Report paging statistics. The following values are displayed:", Dict(
...
"b" => ("-b", "Report I/O and transfer rate statistics. The following values are displayed:", Dict(
...
"areq-sz" => "The average size (in kilobytes) of the requests that were issued to the device. Note: In previous versions, this field was known as avgrq-sz and was expressed in sectors.",
...
"%ufsused" => "Percenalent to option -d below, except that the timestamp is always expressed in seconds since the epoch (00:00:00 UTC 01/01/1970).tage of filesystem space used, as seen by an unprivileged user.",
...
"H" => ("-H", "Report hugepages utilization statistics.The following values are displayed:", Dict(
...
"m" => ("-m { keyword [,...] | ALL }", "Report power management statistics. Note that these statistics depend on sadc's option \"-S POWER\" to be collected.", Dict(

# Possible keywords are CPU, FAN, FREQ, IN, TEMP and USB.
"CPU" => ("With the CPU keyword, statistics about CPU are reported. The following value is displayed:", Dict(
"MHz" => "Instantaneous CPU clock frequency in MHz.",

)),"FAN" => ("With the FAN keyword, statistics about fans speed are reported. The following values are displayed:", Dict(
...
)),"FREQ" => ("With the FREQ keyword, statistics about CPU clock frequency are reported. The following value is displayed:", Dict(
...
)),"IN" => ("With the IN keyword, statistics about voltage inputs are reported. The following values are displayed:", Dict(
...
)),"TEMP" => ("With the TEMP keyword, statistics about devices temperature are reported. The following values are displayed:", Dict(
...
)),"USB" => ("With the USB keyword, the sar command takes a snapshot of all the USB devices currently plugged into the system. At the end of the report, sar will display a summary of all those USB devices. The following values are displayed:", Dict(
...
"n" => ("-n { keyword [,...] | ALL }", "Report network statistics.", Dict(
# Possible keywords are DEV, EDEV, FC, ICMP, EICMP, ICMP6, EICMP6, IP, EIP, IP6, EIP6, NFS, NFSD, SOCK, SOCK6, SOFT, TCP, ETCP, UDP and UDP6."

"DEV" => ("With the DEV keyword, statistics from the network devices are reported. Statistics for all network interfaces are displayed unless a restricted list is specified using option \"--iface=\" (see corresponding option entry). The following values are displayed:", Dict(
...
"EDEV" => ("With the EDEV keyword, statistics on failures (errors) from the network devices are reported. Statistics for all network interfaces are displayed unless a restricted list is specified using option \"--iface=\" (see corresponding option entry). The following values are displayed:", Dict(
"IFACE" =>"Name of the network interface for which statistics are reported.",
...
)),"FC" => ("With the FC keyword, statistics about fibre channel traffic are reported. Note that fibre channel statistics depend on sadc's option \"-S DISK\" to be collected. The following values are displayed:", Dict(
...
"fch_rxw/s" => "The total number of transmission words received per second.",
"fch_txw/s" => "The total number of transmission words transmitted per second.",


)),"ICMP" => ("With the ICMP keyword, statistics about ICMPv4 network traffic are reported. Note that ICMPv4 statistics depend on sadc's option \"-S SNMP\" to be collected. The following values are displayed (formal SNMP names between square brackets):", Dict(
...
)),"EICMP" => ("With the EICMP keyword, statistics about ICMPv4 error messages are reported. Note that ICMPv4 statistics depend on sadc's option \"-S SNMP\" to be collected. The following values are displayed (formal SNMP names between square brackets):", Dict(
...
)),"ICMP6" => ("With the ICMP6 keyword, statistics about ICMPv6 network traffic are reported. Note that ICMPv6 statistics depend on sadc's option \"-S IPV6\" to be collected. The following values are displayed (formal SNMP names between square brackets):", Dict(
...
)),"EICMP6" => ("With the EICMP6 keyword, statistics about ICMPv6 error messages are reported. Note that ICMPv6 statistics depend on sadc's option \"-S IPV6\" to be collected. The following values are displayed (formal SNMP names between square brackets):", Dict(
...
)),"IP" => ("With the IP keyword, statistics about IPv4 network traffic are reported. Note that IPv4 statistics depend on sadc's option \"-S SNMP\" to be collected.The following values are displayed (formal SNMP names between square brackets):", Dict(
...
)),"EIP" => ("With the EIP keyword, statistics about IPv4 network errors are reported. Note that IPv4 statistics depend on sadc's option \"-S SNMP\" to be collected.The following values are displayed (formal SNMP names between square brackets):", Dict(
...
)),"IP6" => ("With the IP6 keyword, statistics about IPv6 network traffic are reported. Note that IPv6 statistics depend on sadc's option \"-S IPV6\" to be collected. The following values are displayed (formal SNMP names between square brackets):", Dict(
...
)),"EIP6" => ("With the EIP6 keyword, statistics about IPv6 network errors are reported. Note that IPv6 statistics depend on sadc's option \"-S IPV6\" to be collected. The following values are displayed (formal SNMP names between square brackets):", Dict(
...
)),"NFS" => ("With the NFS keyword, statistics about NFS client activity are reported. The following values are displayed:", Dict(
...
)),"NFSD" => ("With the NFSD keyword, statistics about NFS server activity are reported. The following values are displayed:", Dict(
...
)),"SOCK" => ("With the SOCK keyword, statistics on sockets in use are reported (IPv4). The following values are displayed:", Dict(
...
)),"SOCK6" => ("With the SOCK6 keyword, statistics on sockets in use are reported (IPv6). Note that IPv6 statistics depend on sadc's option \"-S IPV6\" to be collected. The following values are displayed:", Dict(
...
)),"SOFT" => ("With the SOFT keyword, statistics about software-based network processing are reported. The following values are displayed:", Dict(
...
)),"TCP" => ("With the TCP keyword, statistics about TCPv4 network traffic are reported. Note that TCPv4 statistics depend on sadc's option \"-S SNMP\" to be collected. The following values are displayed (formal SNMP names between square brackets):", Dict(
...
"ETCP" => ("With the ETCP keyword, statistics about TCPv4 network errors are reported. Note that TCPv4 statistics depend on sadc's option \"-S SNMP\" to be collected. The following values are displayed (formal SNMP names between square brackets):", Dict(
...
)),"UDP" => ("With the UDP keyword, statistics about UDPv4 network traffic are reported. Note that UDPv4 statistics depend on sadc's option \"-S SNMP\" to be collected. The following values are displayed (formal SNMP names between square brackets):", Dict(
...
)),"UDP6" => ("With the UDP6 keyword, statistics about UDPv6 network traffic are reported. Note that UDPv6 statistics depend on sadc's option \"-S IPV6\" to be collected. The following values are displayed (formal SNMP names between square brackets):", Dict(
...
"q" => ("-q", "Report queue length and load averages. The following values are displayed:", Dict(
...
"r" => ("-r [ ALL ]", "Report memory utilization statistics. The ALL keyword indicates that all the memory fields should be displayed. The following values may be displayed:", Dict(
...
"S" => ("-S", "Report swap space utilization statistics. The following values are displayed:", Dict(
...
"u" => ("-u [ ALL ]", "Report CPU utilization. The ALL keyword indicates that all the CPU fields should be displayed. The report may show the following fields:", Dict(
...
"v" => ("-v", "Report status of inode, file and other kernel tables. The following values are displayed:", Dict(
...
"W" => ("-W", "Report swapping statistics. The following values are displayed:", Dict(
...
"w" => ("-w", "Report task creation and system switching activity.", Dict(
"proc/s" => "Total number of tasks created per second.",
"cswch/s" =>"Total number of context switches per second.",

)),
"y" => ("-y", "Report TTY devices activity. The following values are displayed:", Dict(
